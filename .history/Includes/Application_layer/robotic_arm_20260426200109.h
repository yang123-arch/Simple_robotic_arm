...
typedef struct {
  ...
  PID_CONTROL pid_joint1_PI; // 关节1 PID控制器
  PID_CONTROL pid_joint1_PD;
  float joint1_target; // 关节1设定角度

  DoubleBuffer_t joint2;     // 关节2电机
  PID_CONTROL pid_joint2_PI; // 关节2 PID控制器
  PID_CONTROL pid_joint2_PD;
  float joint2_target; // 关节2设定角度

  DoubleBuffer_t joint3;     // 关节3电机
  PID_CONTROL pid_joint3_PI; // 关节3 PID控制器
  PID_CONTROL pid_joint3_PD;
  float joint3_target; // 关节3设定角度

  DoubleBuffer_t joint4;     // 关节4电机
  PID_CONTROL pid_joint4_PI; // 关节4 PID控制器
  PID_CONTROL pid_joint4_PD;
  float joint4_target; // 关节4设定角度

  DoubleBuffer_t gripper;     // 夹爪电机
  PID_CONTROL pid_gripper_PI; // 夹爪 PID控制器
  PID_CONTROL pid_gripper_PD;
