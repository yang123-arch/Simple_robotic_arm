...
void Robotic_Arm_Init(void) {
  ...
  PID_Init(&robotic_arm_state.pid_joint1_PI, 1.0f, 0.0f, 0.0f);
  PID_Init(&robotic_arm_state.pid_joint1_PD, 1.0f, 0.0f, 0.0f);
  PID_Init(&robotic_arm_state.pid_joint2_PI, 1.0f, 0.0f, 0.0f);
  PID_Init(&robotic_arm_state.pid_joint2_PD, 1.0f, 0.0f, 0.0f);
  PID_Init(&robotic_arm_state.pid_joint3_PI, 1.0f, 0.0f, 0.0f);
  PID_Init(&robotic_arm_state.pid_joint3_PD, 1.0f, 0.0f, 0.0f);
  PID_Init(&robotic_arm_state.pid_joint4_PI, 1.0f, 0.0f, 0.0f);
  PID_Init(&robotic_arm_state.pid_joint4_PD, 1.0f, 0.0f, 0.0f);
  PID_Init(&robotic_arm_state.pid_gripper_PI, 1.0f, 0.0f, 0.0f);
  PID_Init(&robotic_arm_state.pid_gripper_PD, 1.0f, 0.0f, 0.0f);
