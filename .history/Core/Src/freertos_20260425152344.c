...
osTimerId_t Arm_controlHandle;
const osTimerAttr_t Arm_control_attributes = {.name = "Arm_control"};
...
void MX_FREERTOS_Init(void) {
  ...
  Arm_controlHandle =
      osTimerNew(Arm_Task, osTimerPeriodic, NULL, &Arm_control_attributes);

  /* USER CODE BEGIN RTOS_TIMERS */
  /* start timers, add new ones, ... */

  osTimerStart(Arm_controlHandle, pdMS_TO_TICKS(1));
